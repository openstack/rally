...
def merge(length, *sources):
    ...
    The function merges the sources into lists with the length greater
    or equal to given one.
    ...
    :param: length, expected length of generated lists.
                    Length of the resulted lists would be greater
                    or equal to 'length' and no more then
                    'length' + 'number_of_sources' * 'max_source_list_length',
                    except the last one. Here 'max_source_list_length'
                    is a maximum length of list generated by any source.
