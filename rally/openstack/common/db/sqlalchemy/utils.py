...
from rally.openstack.common import context as request_context
from rally.openstack.common.db.sqlalchemy import models
from rally.openstack.common.gettextutils import _, _LI, _LW
...
def drop_unique_constraint(migrate_engine, table_name, uc_name, *columns,
    ...
    DEPRECATED: this function is deprecated and will be removed from rally.db
