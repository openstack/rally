...
class ContextManager(object):
    ...
    def setup(self):
        """Executes in right order setup() methods of all specified context.

        :returns: dict that contains data generated by context plugins
        """
    ...
    def cleanup(self):
        """Executes in right order cleanup() methods of all specified context.

        Order of cleanup() method is reversed:
