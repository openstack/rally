...
class SVIBGPConnectivity(vcpe_utils.vCPEScenario, neutron_utils.NeutronScenario, nova_utils.NovaScenario, scenario.OpenStackScenario):
   ...
   def run(self, cidr1, cidr2, image, flavor, public_net, username, password):
        ...
        self._create_svi_ports(net1, sub1, "192.168.10")
        self._create_svi_ports(net2, sub2, "192.168.20")
