...
class SVIBGPConnectivity(create_ostack_resources.CreateOstackResources, vcpe_utils.vCPEScenario, neutron_utils.NeutronScenario,
   ...
   def run(self, cidr1, cidr2, image, flavor, public_net, aci_nodes, username, password):
        ...
        try:
               ...
               net1, sub1 = self._create_network_and_subnets({"provider:network_type": "vlan", "apic:nested_domain_name": "dntest1", "apic:nested_domain_type": "dntype1",  "apic:nested_domain_infra_vlan": 1, "apic:nested_domain_service_vlan": 3, "apic:nested_domain_node_network_vlan": 4,"apic:nested_domain_allowed_vlans": {'vlans_list': [2, 3],'vlan_ranges': [{'start': 10, 'end': 12}]}},{"cidr": cidr1}, 1, None)
