...
class TrunkRemoveSubport(vcpe_utils.vCPEScenario, neutron_utils.NeutronScenario, nova_utils.NovaScenario, scenario.OpenStackScenario):
    ...
    def run(self, cidr1, cidr2, cidr3, image, flavor, public_net, username, password):
        ...
        self._remove_subports_from_trunk(trunk, subport_payload)
