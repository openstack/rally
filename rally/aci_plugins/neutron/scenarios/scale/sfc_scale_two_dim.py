...
class SFCScaleTwoDimension(vcpe_utils.vCPEScenario, neutron_utils.NeutronScenario, nova_utils.NovaScenario, scenario.OpenStackScenario):

    def run(self, src_cidr, dest_cidr, vm_image, service_image1, service_image2, service_image3, flavor, public_network, username, password, x, y):
        ...
        print "\nCreating two-dimensional service function chain...\n"
        ppg = []
        ...
        for i in range(0, int(x)):
            ...
            for j in range(0, int(y)):
                ...
                kwargs.update({'nics': nics})
                service_vm = self._boot_server(service_image[i], flavor, False, **kwargs)
