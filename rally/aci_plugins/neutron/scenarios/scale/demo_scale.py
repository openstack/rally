...
class DemoScale(vcpe_utils.vCPEScenario, neutron_utils.NeutronScenario, nova_utils.NovaScenario, scenario.OpenStackScenario):
    ...
    def run(self, access_network, access_network_bgp_asn, nat_network, nat_network_bgp_asn, svi_scale, bras_image, nat_image, service_image1, flavor, username, password, access_router_ip, scale):
        ...
        for i in range(1, int(scale)+1):
            ...
            self._create_svi_ports(net[i-1], sub[i-1], "192.168.0", svi_scale)
